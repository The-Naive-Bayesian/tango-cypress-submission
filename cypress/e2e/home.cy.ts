...
describe('Home Page', () => {
  beforeEach(() => {
    ...
    cy.get(HomePage.teamLibraryHeaderSelector, {timeout: 15000}).should('be.visible');
  });
  ...
  it('displays "No Tangos here, yet" message', () => {
    cy.get(HomePage.noTangosMessageSelector).should('contain.text', 'No Tangos here, yet.');
  });
});
